...
**Repository:** [opencauldron/docs](https://github.com/opencauldron/docs)
...
Fork [opencauldron/docs](https://github.com/opencauldron/docs) on GitHub, then clone your fork:
...
All documentation content is in `src/content/docs/`. The directory structure maps directly to URL paths:
...
├── cli.md                    → /cli
├── guides/
│   ├── api-keys.md           → /guides/api-keys
│   ├── adding-providers.md   → /guides/adding-providers
│   └── ...
├── contributing/
│   ├── index.md              → /contributing
│   ├── development-setup.md  → /contributing/development-setup
│   └── ...
└── reference/
...
```bash
touch src/content/docs/contributing/my-new-guide.md
```
...
Open the file in `src/content/docs/` and edit it directly. The dev server hot-reloads on save.
...
- [Contributing Overview](/contributing) — Full contribution process
- [Code Style and PR Guidelines](/contributing/code-style) — PR conventions
