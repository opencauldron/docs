...
See the [API Keys guide](/guides/api-keys) for how to obtain keys for every supported provider.
...
:::note
Local storage does not work for image-to-video generation because AI provider APIs need a publicly accessible URL for the reference image. If you are working on image-to-video features, configure Cloudflare R2 instead. See the [Storage guide](/guides/storage).
:::
...
- [Adding a Provider](/guides/adding-providers) — The most common contribution: adding a new AI model
- [Code Style and PR Guidelines](/contributing/code-style) — Linting, formatting, and PR conventions
- [Issues and Feature Requests](/contributing/issues-and-requests) — How to file a bug report or feature request
