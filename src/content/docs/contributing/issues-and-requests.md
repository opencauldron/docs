...
- Whether you are willing to implement it yourself (if so, see [Adding a Provider](/guides/adding-providers))
...
- [Adding a Provider](/guides/adding-providers) — If you want to implement a provider yourself
- [Contributing Overview](/contributing) — The full contribution process
- [Development Setup](/contributing/development-setup) — Getting the app running for local development
