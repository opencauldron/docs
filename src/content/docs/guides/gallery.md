...
The gallery shows every asset generated by your team in reverse chronological order. It is the central place to find, review, and reuse your generated media. For tagging, campaign assignment, and the approval workflow, see [Library](/guides/library/).
...
To set up brands or manage their names and colors, see [Brand Management](/guides/brands/).
...
From there you can write a prompt and generate a new image that draws from the selected gallery image. See [References](/guides/references/) for more on how reference images work.
...
Every asset has a **Thread** tab in the lightbox. Open it to leave a note, ask a question, or start a conversation with your team right next to the work itself.

- Messages appear in real time — no refresh needed.
- React with any emoji, @-mention a workspace member, or reply to a specific message.
- Paste or drag images and video clips into a message to attach them inline.
- Mention notifications appear in your bell with a deep-link back to the asset and message.
