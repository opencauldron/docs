...
- Node.js / Bun development environment set up per the [installation guide](/installation)
...
- [API Keys](/guides/api-keys) — Environment variable names for all existing providers
- [Working with Models](/guides/models) — How models and variants appear in the UI
