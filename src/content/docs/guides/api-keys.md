...
- [Configuration](/configuration) — Database, storage, and auth setup
- [Working with Models](/guides/models) — Full model capabilities, parameters, and cost comparison
- [Generation Parameters](/guides/parameters) — What each model parameter does
