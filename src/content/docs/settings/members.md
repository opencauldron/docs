...
OpenCauldron has two layers of access. Your **Studio** is the team's top-level account — everyone who can sign in belongs to it. Inside the studio, each [brand](/guides/brands/) has its own members and its own roles. Adding someone to the studio lets them sign in; adding them to a brand decides what they can do with that brand's work.
